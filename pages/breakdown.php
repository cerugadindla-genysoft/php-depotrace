...
<p>Analyze the types of users, usage frequency, and session breakdowns per user category.</p>
...
<div class="team-header">
  ...
  <div class="column-dropdown" id="columnDropdown">
    ...
    <div class="column-list">
      ...
      <div class="column-toggle"><label class="switch"><input type="checkbox" checked><span class="slider round"></span></label><span>Name</span></div>
      ...
      <div class="column-toggle"><label class="switch"><input type="checkbox" checked><span class="slider round"></span></label><span>PhoneNumber</span></div>
  ...
  <div class="header-cell">
    ...
    <div class="header-icons">
      ...
      <tbody>
        <!-- No data; only layout -->
        <?php
$mysqli = new mysqli('localhost', 'root', '', 'depotrace_customers');
$mysqli->set_charset('utf8mb4');

$sql = "SELECT _id, name, email, phoneNumber, country, occupation, role  FROM customers";
...
//   column
  ...
  if (window.initFlatpickrIfNeeded) {
    window.initFlatpickrIfNeeded();
  }
  </script>
